"""chatter_23661 URL Configuration
...
admin.site.site_title = "Chatter Admin Portal"
admin.site.index_title = "Chatter Admin"

# swagger
api_info = openapi.Info(
    title="Chatter API",
    default_version="v1",
    description="API documentation for Chatter App",
)
